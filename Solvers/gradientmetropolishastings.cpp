...
GradientMetropolisHastings::GradientMetropolisHastings(std::unique_ptr<class Random> rng, double timeStep, double D, double epochs, double lr)
...
bool GradientMetropolisHastings::step(
    double stepLength,
